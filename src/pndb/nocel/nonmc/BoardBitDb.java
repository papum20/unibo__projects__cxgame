...
public class BoardBitDb extends _BoardBitDb<BoardBitDb, BoardBit> {
	...
	public <O extends _Operators> BoardBitDb(int M, int N, int X, _Operators operators) {
	...
	private <O extends _Operators> BoardBitDb(BoardBitDb B, boolean copy_threats, _Operators operators) {
