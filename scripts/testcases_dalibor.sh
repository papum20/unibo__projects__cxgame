...
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.nocel.Player				-r ${TESTS} > ${OUTDIR}/ranch_nocel_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_nocel_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.nocel.nonmc.Player			-r ${TESTS} > ${OUTDIR}/ranch_nonmc_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_nonmc_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.nocel.nonmc.tryit.Player	-r ${TESTS} > ${OUTDIR}/ranch_tryit_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_tryit_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.nonmc.Player				-r ${TESTS} > ${OUTDIR}/ranch_nomc0_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_nomc0_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.nonmc.tryit.Player			-r ${TESTS} > ${OUTDIR}/ranch_tryt0_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_tryt0_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.alpha.Player				-r ${TESTS} > ${OUTDIR}/ranch_alpha_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_alpha_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.alpha.nonum.Player			-r ${TESTS} > ${OUTDIR}/ranch_nonum_18147.txt
cat scripts/testcases_dalibor.sh >> ${OUTDIR}/ranch_nonum_18147.txt
./ltest 18 14 7		pndb.nocel.nonmc.tryit.ranch.Player pndb.alpha.halfnPlayer			-r ${TESTS} > ${OUTDIR}/ranch_halfn_18147.txt
